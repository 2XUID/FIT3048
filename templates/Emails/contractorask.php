        ...
        <div class="emails form content">
            ...
            <fieldset>
                <div class="row gx-3 mb-3">
                    ...
                    <div class="mb-3">
                        <?php echo $this->Form->control('email_name', ['class' => 'form-control', 'label' => 'Question Subject:']); ?>
                    </div>
                </div>
                <div class="mb-3">
                    <?php echo $this->Form->control('email_body', ['class' => 'form-control col-md-6 ', 'label' => 'Question detail:']); ?>
                </div>
            </fieldset>
