...
<div class="col-lg-7" style="float:none;margin:auto;">
    <div class="column-responsive column-80">
        <div class="emails form content">
            <a class="btn btn-sm btn-light text-primary" href="<?= $this->Url->build(['controller' => 'Emails', 'action' => 'view', $email_id]) ?>">
            ...
            <fieldset>
                <div class="row gx-3 mb-3">
                    ...
                    <div class="mb-3">
                        <?php echo $this->Form->control('email_name', ['class' => 'form-control', 'label' => 'Query Response Subject:']); ?>
                    </div>
                </div>
                <div class="mb-3">
                    <?php echo $this->Form->control('email_body', ['class' => 'form-control col-md-6 ', 'label' => 'Query Response:']); ?>
                </div>
            </fieldset>
